...
class HierarchicalAlignmentUnitTest(unittest.TestCase):
    def test_hierarchical_report_exposes_all_levels(self) -> None:
        ...
        self.assertIn("paragraph_global_metrics", report)
        self.assertIn("global_metrics", report)
        self.assertIn("source_paragraph_coverage", report["global_metrics"])
        self.assertIn("source_sentence_coverage", report["global_metrics"])
        self.assertIn("subtree_row_rate", report["global_metrics"])
        self.assertIn("subtree_source_token_coverage", report["global_metrics"])
        self.assertIn("phrase_target_token_coverage", report["global_metrics"])
